...
h2(#overview). Acerca de esta clase

Las primeras semanas cubriremos la sintaxis y conceptos básicos, después comenzaremos a ampliarlo con más ejercicios.

Algunos ejemplos serán dados escritos para el intérprete, otros como si fueran codigo en un archivo.

Tener el intérprete disponible hace más sencillo explorar el espacio de un problema.
...
* Es conciso
** Inferencia de tipos
** Sintaxis literal para creación de funciones
* Interoperabilidad con Java
** Reuso de bibliotecas de Java
** Reuso de herramienttas de Java
** Sin penalización del desempeño

h3. Cómo Scala?

* Compila a bytecode de Java
* Opera en cualquier JVM
** Y hasta en algunas JVMs no-estandar como Dalvik
** El compilador de Scala fue escrito por el autor del compilador de Java

h3. Piensa Scala

Para scarle más provecho a estas clases debes aprender Scala con una mente fresca. Scala no es tan solo un Java más bonito. 

h3. Inicia el Interprete

Inicializa la <code>sbt console</code> incluida.
